...
def get_tweets(directory, start_date, end_date, hashtags):
    """
    Extract tweets from .json.bz2 files in the given directory that meet the specified criteria.
    """
    tweets = []
...
def parse_args(argv):
    ...
    parser.add_argument("-d", "--directory", default="data", help="Path to the data directory")
